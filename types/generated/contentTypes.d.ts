...
export interface ApiCommonContentCommonContent
  extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    cancellationUrl: Schema.Attribute.String &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: false;
        };
    ...
    >;
    newsletterLabelTextCode: Schema.Attribute.String &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: false;
        };
      }>;
    newsletterSlug: Schema.Attribute.JSON &
    ...
    privacyNoticeDownloadUrl: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
    ...
    publishedAt: Schema.Attribute.DateTime;
    successActionButtonLabel: Schema.Attribute.String &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    successActionButtonUrl: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
...
export interface ApiCouponConfigCouponConfig
  extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    stripePromotionCodes: Schema.Attribute.Component<
...
export interface ApiOfferingOffering extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    apiIdentifier: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.Unique &
      Schema.Attribute.SetMinMaxLength<{
        maxLength: 32;
    ...
    countries: Schema.Attribute.JSON &
      ...
      >;
    couponConfig: Schema.Attribute.Relation<
      'oneToOne',
      'api::coupon-config.coupon-config'
    >;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    defaultPurchase: Schema.Attribute.Relation<
      'oneToOne',
    ...
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    stripeLegacyPlans: Schema.Attribute.Component<
...
export interface ApiPurchaseDetailPurchaseDetail
  extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    webIcon: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: false;
...
export interface ApiPurchasePurchase extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    publishedAt: Schema.Attribute.DateTime;
    purchaseDetails: Schema.Attribute.Relation<
      'oneToOne',
      'api::purchase-detail.purchase-detail'
    >;
...
export interface ApiRelyingPartyRelyingParty
  ...
  attributes: {
    ...
    l10nId: Schema.Attribute.String & Schema.Attribute.Unique;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
...
export interface ApiServiceService extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    oauthClientId: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.Unique;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
...
export interface ApiSubgroupSubgroup extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    >;
    publishedAt: Schema.Attribute.DateTime;
    rankedOfferings: Schema.Attribute.Component<
      'offerings.ranked-offerings',
      true
    >;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
